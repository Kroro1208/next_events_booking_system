                        ...
                        <TableRow key={event._id}>
                            ...
                            <TableCell>
                                <div className="flex gap-5">
                                    ...
                                    <Button isIconOnly className="bg-blue-300 hover:bg-blue-600 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition duration-300 ease-in-out">
